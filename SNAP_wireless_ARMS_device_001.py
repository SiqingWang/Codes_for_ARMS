...
"""
  ...
  Voltage_divider_multiple_4 for device 001.py
    ...
    if pinDecision <= 5:
        ...
        if secondCounter == 1:
            ...
            if secondCounter % 3 == 0:
                ...
                eventString =  "The 001 strain reading is 0000" + str(StrainVal) + " "  + str(pinNumber)
            ...
            if secondCounter % 3 == 0:
                rpc(portalAddr, "logEvent", "Device 001 Sleeping") 
